...
import {
  ...
  SheetHeader,
  SheetTitle,
} from '@rekode/ui/components/sheet';
import { Skeleton } from '@rekode/ui/components/skeleton';
import { Tooltip, TooltipContent, TooltipTrigger } from '@rekode/ui/components/tooltip';
import { useIsMobile } from '@rekode/ui/hooks/use-mobile';
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'relative w-(--sidebar-width) bg-transparent transition-[width] duration-200 ease-in-out will-change-auto',
      ...
      <div
        ...
        data-side={side}
        className={cn(
          'will-change fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-200 ease-in-out data-[side=left]:left-0 data-[side=left]:group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)] data-[side=right]:right-0 data-[side=right]:group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1)] md:flex',
...
function SidebarInset({ className, ...props }: React.ComponentProps<'main'>) {
  return (
    <main
      ...
      className={cn(
        'bg-background relative flex w-full flex-1 min-w-0 flex-col md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2',
        className,
      )}
      {...props}
    />
