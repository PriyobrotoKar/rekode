...
import { DotMatrixBase, rowMajorIndex } from '@rekode/ui/components/dotmatrix-core';
import type {
  DotAnimationResolver,
  DotMatrixCommonProps,
} from '@rekode/ui/components/dotmatrix-core';
import {
  useDotMatrixPhases,
  usePrefersReducedMotion,
  useSteppedCycle,
} from '@rekode/ui/hooks/dotmatrix-hooks';
